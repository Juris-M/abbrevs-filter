...
var require = (function() {
	...
	var loader = Loader({
		id: 'abbrevs-filter/require',
		paths: {
			'': 'resource://abbrevs-filter/',
			'containers/': 'chrome://abbrevs-filter/content/containers/',
			'components/': 'chrome://abbrevs-filter/content/components/',
			'abbrevs-filter/': 'chrome://abbrevs-filter/content/modules/',
			'@abbrevs-filter/': 'chrome://abbrevs-filter/content/modules/'
		},
		globals
	});
