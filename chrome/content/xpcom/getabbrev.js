...
var db = this.db;
var saveEntry = this.saveEntry;
var CSL = Zotero.CiteProc.CSL;
this.citeproc = CSL;

// Install a custom abbreviations handler on the processor.
AbbrevsFilter.prototype.getAbbreviation = function (listname, obj, jurisdiction, category, key, itemType, noHints) {
    ...
    try {
        ...
        for (var i = 0, ilen = jurisdictionIDs.length; i < ilen; i += 1) {
            ...
            if (abbr) {
                ...
                //    saveEntry (listname, jurisdiction, category, key, abbr);
                //}
                haveHit = true;
                break;
            }
            ...
            if (sql) {
                for (var i = 0, ilen = jurisdictionIDs.length; i < ilen; i += 1) {
                    ...
                    if (newlst.join(" ") !== jsKey) {
                        ...
                        saveEntry (listname, jurisdiction, category, key, newlst.join(" "));
                    } else {
